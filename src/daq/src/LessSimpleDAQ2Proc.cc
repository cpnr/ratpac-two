...
//    pmt->GetTime() will give the front end time w.r.t the global time (t = 0
//    is when the event is first generated) ev->GetDeltaT() will give the time
//    BETWEEN the subevents. For example,
//       for the first subevent, the DeltaT is the dt between t = 0 (event is
//       generated) and cluster time of the first subevent for the second
//       subevent, the DeltaT is the dt between the cluster time of the first
//       subevent and the cluster time of the second subevent for the third
//       subevent, the DeltaT is the dt between the cluster time of the second
//       subevent and the cluster time of the third subevent and so on...
